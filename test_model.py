...
def test_UnetTransformer(args):
    ...
    plt.axis("off")
    plt.imshow(sample_grid.permute(1, 2, 0).cpu(), vmin=0.0, vmax=1.0)
    plt.savefig("./playground_imgs/SDM_Pipeline_MNIST_imgs/samples_scorebased_UnetTransformer_num4.png")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test-unettransforme", action="store_true", help="Transformer Model")
